...
(function() {
  var Route, Table, afterDelay, api, clobberProperty, compact, endsWith, filter, getDelay, lastChar, merge, parseData, singularize, _addEventListener, _getAllResponseHeaders, _open, _send, _setRequestHeader;
