...
(function() {
  var DB, Route, Table, afterDelay, api, chop, clobberProperty, clone, compact, endsWith, filter, getDelay, lastChar, merge, parseData, pluralize, singularize, _addEventListener, _getAllResponseHeaders, _open, _send, _setRequestHeader;
