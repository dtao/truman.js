...
(function() {
  var Route, afterDelay, api, clobberProperty, compact, createRecord, getDelay, getNextId, getRecord, getTable, merge, parseData, prefixTableName, saveTable, _addEventListener, _getAllResponseHeaders, _open, _send;
