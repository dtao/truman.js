...
(function() {
  var Route, Table, afterDelay, api, chop, clobberProperty, clone, compact, endsWith, filter, getDelay, lastChar, merge, parseData, pluralize, singularize, _addEventListener, _getAllResponseHeaders, _open, _send, _setRequestHeader;
  ...
  api = {
    ...
    get: function(tableName, recordId, callback) {
      return afterDelay(getDelay(), function() {
        return callback(new Table(tableName).get(recordId));
      });
    },
    update: function(tableName, recordId, data, contentType, callback) {
      ...
      return afterDelay(getDelay(), function() {
        return callback(new Table(tableName).update(recordId, data));
      });
    },
    create: function(tableName, data, options) {
      ...
      return afterDelay(getDelay(), function() {
        ...
        return callback(new Table(tableName).insert(data));
      });
    },
